package com.juliuskrah.leaderboard.event.framework;

import java.util.HashMap;
import java.util.Map;

/**
 * Handles the routing of {@link Event} messages to associated handlers. A
 * {@link HashMap} is used to store the association between events and their
 * respective handlers.
 * 
 * @author Julius Krah
 */
public class EventDispatcher {
	...
	public <E extends Event> void dispatch(E event) {
		Handler<E> handler = (Handler<E>) handlers.get(event.getType());
		if (handler != null) {
